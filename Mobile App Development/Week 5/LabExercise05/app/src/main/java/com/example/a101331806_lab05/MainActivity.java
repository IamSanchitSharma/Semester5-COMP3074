...
public class MainActivity extends AppCompatActivity {
    ...
    void initDatabase(SQLiteDatabase db){
        ...
        values.put(NameContract.NameEntry.COLUMN_NAME_NAME, "Jpon");
    ...
    long getNamesCount(SQLiteDatabase db){
        ...
        while (c.moveToNext()){
            int id = c.getColumnIndexOrThrow("CNT");
            cnt = c.getLong(id);
        }
        return cnt;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(pref.contains(getString(R.string.pref_key))){
            ...
            txt.setText("User not found");
            SharedPreferences.Editor editor = pref.edit();
            editor.putString(getString(R.string.pref_key), "Sanchit");
            editor.apply();
        }
